		 ...
		 --><div class="block grid__item one-whole">
			...
			<div class="grid">
				<div class="block grid__item one-whole bp-small-2--one-half bp-large--one-third sonderanfertigung">
					...
					<figure>
						<a class="noarr" href="#"><img class="notrans" src="images/produkte_uebersicht/poolleuchte_feno.jpg" alt=""></a>
						<figcaption>LED Profil, Stichpunkt, Produktbeschreibung, Stecker, Strombedingungen</figcaption>
					</figure>
				</div><!--
				 --><div class="block grid__item one-whole bp-small-2--one-half bp-large--one-third sonderanfertigung">
					<h3 class="headline"><a href="#">Loacker Schlern</a></h3>
					<figure>
						<a class="noarr" href="#"><img class="notrans" src="images/produkte_uebersicht/loacker_schlern.jpg" alt=""></a>
						<figcaption>LED Profil, Stichpunkt, Produktbeschreibung, Stecker, Strombedingungen</figcaption>
					</figure>
				</div><!--
				 --><div class="block grid__item one-whole bp-small-2--one-half bp-large--one-third sonderanfertigung">
					<h3 class="headline"><a href="#">Laibungsleuchte La Vie</a></h3>
					<figure>
						<a class="noarr" href="#"><img class="notrans" src="images/produkte_uebersicht/laibungsleuchte_la_vie.jpg" alt=""></a>
						<figcaption>LED Profil, Stichpunkt, Produktbeschreibung, Stecker, Strombedingungen</figcaption>
					</figure>
				</div>
			</div>
