	...
	<div class="content produkte grid">
		...
		<div class="block grid__item one-whole">
		 ...
		 --><div class="block grid__item one-whole bp-small-2--one-half bp-large--one-third sonderanfertigung">
			...
			<figure>
				<a class="noarr" href="#"><img src="images/produkte_uebersicht/sonder_01.jpg" alt=""></a>
				<figcaption>LED Profil, Stichpunkt, Produktbeschreibung, Stecker, Strombedingungen</figcaption>
			</figure>
		</div><!--
		 --><div class="block grid__item one-whole bp-small-2--one-half bp-large--one-third sonderanfertigung">
			<h3 class="headline"><a href="#">kor_#02</a></h3>
			<figure>
				<a class="noarr" href="#"><img src="images/produkte_uebersicht/sonder_02.jpg" alt=""></a>
				<figcaption>LED Profil, Stichpunkt, Produktbeschreibung, Stecker, Strombedingungen</figcaption>
			</figure>
		</div><!--
		 --><div class="block grid__item one-whole bp-small-2--one-half bp-large--one-third sonderanfertigung">
			<h3 class="headline"><a href="#">kor_#03</a></h3>
			<figure>
				<a class="noarr" href="#"><img src="images/produkte_uebersicht/sonder_03.jpg" alt=""></a>
				<figcaption>LED Profil, Stichpunkt, Produktbeschreibung, Stecker, Strombedingungen</figcaption>
			</figure>
		</div>
	</div>
